...
public extension YouTubeChannel {
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use fetchInfos(youtubeModel: YouTubeModel, useCookies: Bool? = nil, result: @escaping (Result<ChannelInfosResponse, Error>) -> ()) instead.") // safer and better to use the Result API instead of a tuple
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use fetchInfos(youtubeModel: YouTubeModel, useCookies: Bool? = nil) async throws -> ChannelInfosResponse instead.") // safer and better to use the throws API instead of a tuple
    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)

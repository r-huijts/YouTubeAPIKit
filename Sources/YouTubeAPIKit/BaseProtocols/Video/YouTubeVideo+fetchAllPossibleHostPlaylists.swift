...
public extension YouTubeVideo {
    ...
    /// Get all the user's playlists and if the video is already inside or not.
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use fetchAllPossibleHostPlaylists(youtubeModel: YouTubeModel, result: @escaping (Result<AllPossibleHostPlaylistsResponse, Error>) -> Void) instead.") // safer and better to use the Result API instead of a tuple
    ...
    /// Get all the user's playlists and if the video is already inside or not.
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use fetchAllPossibleHostPlaylists(youtubeModel: YouTubeModel) async throws -> AllPossibleHostPlaylistsResponse instead.") // safer and better to use the throws API instead of a tuple
    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)

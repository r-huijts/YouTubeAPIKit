...
public extension YouTubeVideo {
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use fetchStreamingInfosWithDownloadFormats(youtubeModel: YouTubeModel, useCookies: Bool? = nil, infos: @escaping (Result<VideoInfosResponse, Error>) -> ()) instead.") // safer and better to use the Result API instead of a tuple
    func fetchStreamingInfosWithDownloadFormats(
            youtubeModel: YouTubeModel,
            useCookies: Bool? = nil,
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use fetchStreamingInfosWithDownloadFormats(youtubeModel: YouTubeModel, useCookies: Bool? = nil) async throws -> VideoInfosResponse instead.") // safer and better to use the throws API instead of a tuple
    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)
    func fetchStreamingInfosWithDownloadFormats(
            youtubeModel: YouTubeModel,
            useCookies: Bool? = nil

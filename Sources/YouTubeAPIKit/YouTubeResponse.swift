...
public protocol YouTubeResponse: Sendable {
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use sendRequest(youtubeModel: YouTubeModel, data: RequestData, useCookies: Bool?, result: @escaping (Result<Self, Error>) -> ()) instead.") // safer and better to use the Result API instead of a tuple
    /// A function to call the request of the given YouTubeResponse. For more informations see ``YouTubeModel/sendRequest(responseType:data:useCookies:result:)``.

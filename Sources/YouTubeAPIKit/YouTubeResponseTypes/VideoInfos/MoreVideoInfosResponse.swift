...
public struct MoreVideoInfosResponse: YouTubeResponse {
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use getRecommendedVideosContination(youtubeModel: YouTubeModel, result: @escaping (Result<RecommendedVideosContinuation, Error>) -> ()) instead.") // safer and better to use the Result API instead of a tuple
    /// Get the continuation of the recommended videos.
    ///
    /// - Parameter youtubeModel: the model to use to execute the request.
    /// - Parameter result: the closure to execute when the request is finished.
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use getRecommendedVideosContination(youtubeModel: YouTubeModel) async throws -> RecommendedVideosContinuation instead.") // safer and better to use the throws API instead of a tuple
    /// Get the continuation of the recommended videos.
    ///
    /// - Parameter youtubeModel: the model to use to execute the request.
    /// - Returns: A ``MoreVideoInfosResponse/RecommendedVideosContinuation`` or an error.
    ...
    public struct AuthenticatedData: Codable, Sendable {
        ...
        @available(*, deprecated, message: "This init will be removed in a future YouTubeAPIKit version, please use YTLikeStatus instead.")
        ...
        @available(*, deprecated, message: "This enum will be removed in a future YouTubeAPIKit version, please use YTLikeStatus instead.")

...
public extension YTSearchResult {
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use canBeDecoded(json: JSON) instead. You can convert your Data into JSON by calling the JSON(_ data: Data) initializer.") // deprecated as you can't really find some result JSON in raw data.

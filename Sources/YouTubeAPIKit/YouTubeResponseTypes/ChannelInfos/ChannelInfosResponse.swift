...
public struct ChannelInfosResponse: YouTubeResponse {
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use getChannelContent(type: RequestTypes, youtubeModel: YouTubeModel, useCookies: Bool? = nil, result: @escaping (Result<ChannelInfosResponse, Error>) -> ()) instead.") // safer and better to use the result API instead of a tuple
    /// Get a content from a channel, the content represents one of the tabs you see when browsing on YouTube's website in a channel's webpage. For example: Home, Videos, Shorts, Playlists etc...
    /// - Parameters:
    ///   - type: Type of content requested, (the tab of the wanted content).
    ///   - youtubeModel: the ``YouTubeModel`` that will be used to get the request headers.
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use getChannelContent(type: RequestTypes, youtubeModel: YouTubeModel) async throws -> ChannelInfosResponse instead.") // safer and better to use the throws API instead of a tuple
    /// Get a content from a channel, the content represents one of the tabs you see when browsing on YouTube's website in a channel's webpage. For example: Home, Videos, Shorts, Playlists etc...
    /// - Parameters:
    ///   - type: Type of content requested, (the tab of the wanted content).
    ///   - youtubeModel: the ``YouTubeModel`` that will be used to get the request headers.
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use getChannelContentContinuation<T: ChannelContent>(_: T.Type, youtubeModel: YouTubeModel, useCookies: Bool? = nil, result: @escaping (Result<ContentContinuation<T>, Error>) -> Void) instead.") // safer and better to use the throws API instead of a tuple
    /// Get the continuation results for a certain ChannelContent.
    /// - Parameters:
    ///   - youtubeModel: the ``YouTubeModel`` that will be used to get the request headers.
    ///   - useCookies: boolean that precises if the request should include the model's ``YouTubeModel/cookies``, if set to nil, the value will be taken from ``YouTubeModel/alwaysUseCookies``. The cookies will be added to the `Cookie` HTTP header if one is already present or a new one will be created if not.
    ...
    @available(*, deprecated, message: "This method will be removed in a future version of YouTubeAPIKit, please use public func getChannelContentContinuation<T: ChannelContent>(_: T.Type, youtubeModel: YouTubeModel, useCookies: Bool? = nil) async throws -> ContentContinuation<T> instead.") // safer and better to use the throws API instead of a tuple
    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)
    /// Get the continuation results for a certain ChannelContent.
    /// - Parameters:
    ///    - youtubeModel: the ``YouTubeModel`` that will be used to get the request headers.

import XCTest
@testable import YouTubeAPIKit

final class YouTubeAPIKitTests: XCTestCase {
    private let YTM = YouTubeModel()
    
    /// Keep them secret! Make sure you remove them after having tested YouTubeAPIKit. If they're let empty, the requests requiring authentification will pass but won't be tested.
    private let cookies = ""
    ...
    func testCreateCustomHeaders() async throws {
        ...
        let myCustomHeadersFunction: () -> HeadersList = {
            HeadersList(
                url: URL(string: "https://raw.githubusercontent.com/b5i/antoinebollengier/main/YouTubeAPIKitTests/CreateCustomHeadersGET.json")!,
                method: .GET,
                headers: [
    ...
    func testLogger() async throws {
        ...
        struct ModulableResponse: YouTubeResponse {
            static var headersType: YouTubeAPIKit.HeaderTypes = .home // random headers, the request's data won't be checked.
    ...
    func testHeadersToRequest() async {
        ...
        let decodedURLShouldBe = "https://raw.githubusercontent.com/b5i/antoinebollengier/main/YouTubeAPIKitTests/CreateCustomHeadersGET.json?q=testquery/@&t=query@/"
    ...
    func testPlaylistActions() async throws {
        ...
        let newPlaylistName = "YouTubeAPIKitTest-\(UUID().uuidString)"
    ...
    func testAuthActionsVideoComments() async throws {
        ...
        let createCommentText = "YouTubeAPIKit test ?=/\\\""
        ...
        try await Task.sleep(nanoseconds: 5_000_000_000)
        try await createdComment.editComment(withNewText: "YouTubeAPIKit", youtubeModel: YTM)
        try await Task.sleep(nanoseconds: 5_000_000_000)
